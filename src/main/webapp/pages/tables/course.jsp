            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                    ...
                    <a href="#" class="dropdown-item">
                        <!-- Message Start -->
                        <div class="media">
                            <img src="<%=request.getContextPath()%>/dist/img/user3-128x128.jpg" alt="User Avatar"
                                 class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                    Nora Silvester
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<%=request.getContextPath()%>/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                         alt="User Image">
                </div>
                <div class="info">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<%=request.getContextPath()%>/allData" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>学生</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<%=request.getContextPath()%>/getAllCourses" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>课程</p>
                                </a>
                            </li>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">所有课程信息</h3>
                                            <a href="<%=request.getContextPath()%>/pages/tables/addCourse.jsp">添加课程</a>
                                        </div>
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <table id="example2" class="table table-bordered table-hover">
                                                ...
                                                <c:forEach items="${sessionScope.courses}" var="course">
                                                    ...
                                                    <tr>
                                                        <td>${course.CName}</td>
                                                        <td>${course.week}</td>
                                                        <td>${course.begin}-${course.end}</td>
                                                        <td>${course.CMajor}</td>
                                                        <td>${course.CTeacher}</td>
                                                        <td>
                                                            <a href="<%=request.getContextPath()%>/getData?studentId=${course.id}">
                                                                <button type="button"
                                                                        class="btn btn-block bg-gradient-info">修改
                                                                </button>
                                                            </a>
                                                        </td>
                                                        <td>
                                                            <a class="deleteStu"
                                                               href="<%=request.getContextPath()%>/deleteData?id=${course.id}">
                                                                <button type="button"
                                                                        class="btn btn-block bg-gradient-warning">删除
                                                                </button>
                                                            </a>
                                                        </td>
                                                    </tr>
